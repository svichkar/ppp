...
public class StudentDaoImpl extends AbstractDaoImpl implements StudentDao {
	...
	return super.delete("student_id", student.getStudentId(), TABLE_NAME);
    }

    @Override
    public Student getStudentById(int studentId) {
	List<Student> studentList = super.find("student_id", String.valueOf(studentId), Student.getMap(),
		Student.class);
	...
	return super.findBySeveralFields(new String[] { "student_group_id" }, new String[] { String.valueOf(groupId) },
		Student.getMap(), Student.class);
    }
