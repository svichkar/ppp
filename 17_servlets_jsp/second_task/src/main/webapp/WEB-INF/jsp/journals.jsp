...
<t:template title="Journal">
	...
	<div class="forms">
       ...
       <option value="<c:out value="${student.student.studentId}"/>"><c:out
										value="${student.student.firstName} ${student.student.lastName}, ${student.group.groupName}" /></option>
       </c:forEach>
       </select>
       </td>
       </tr>
       ...
       <h3>Journal records</h3>       
        <table class="centered-table" border="1">
            ...
            <c:forEach var="journal" items="${journals}">
                <tr>
                	<td><c:out value="${journal.journal.journalId}" /></td>
                    <td><c:out
								value="${journal.student.student.firstName} ${journal.student.student.lastName}, ${journal.student.group.groupName}" /></td>
                    <td><c:out
                    ...
                    <input type="hidden" name="journal_id"
									value="<c:out value="${journal.journal.journalId}"/>">
