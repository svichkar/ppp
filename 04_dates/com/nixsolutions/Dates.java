...
/**
 * Contains methods for performing specific operations with dates, such as
 * checking the length of the month, dates of week days, finding period between
 * dates, printing localized dates.
 */
public class Dates {
    ...
    private static void getDatesOfDays() {
        try {
            ...
            System.out.println(
                    "The following days of the given month are Mondays:");
    ...
    private static void fullDateRegional() {
        ...
        dateFormatCanada = DateFormat.getDateInstance(DateFormat.FULL,
                Locale.CANADA);
        dateFormatGermany = DateFormat.getDateInstance(DateFormat.FULL,
                Locale.GERMAN);
        Calendar calendar = Calendar.getInstance();
        ...
        datePakistan = DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)
                .withLocale(new Locale("en", "PK")).format(LocalDate.now());
        dateVietnam = DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL)
                .withLocale(new Locale("vi", "VN")).format(LocalDate.now());
