...
<t:template title="Users">
	...
	<div class="forms">
       <h2>Users</h2>
       <h3>Add User</h3>
       <form action="users" method="post" onsubmit="return validate(this, optionsForAddUser)">
       <table class="form-table">
       <tr>
					<td>Login : </td>
       <td><input type="text" name="newLogin" required>
       <span class="hint">Enter login in text format</span></td>
				</tr>
       <tr>
					<td>Email : </td>
       <td><input type="text" name="newEmail" required>
       <span class="hint">Enter email in format xxx@xxx.xxx</span></td>
				</tr>
       <tr>
					<td>Password : </td>
       <td><input type="password" name="newPassword" required>
       <span class="hint">Enter password</span></td>
				</tr>
       <tr>
					<td>Role : </td>
