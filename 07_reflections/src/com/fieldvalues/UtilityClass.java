...
public class UtilityClass {
    ...
    public Object getPublicValueBeanUtils(Object inputObject, String fld) throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        Object fieldValue = null;
        if (FieldUtils.getField(inputObject.getClass(), fld, true).isAnnotationPresent(Public.class)) {
            fieldValue = PropertyUtils.getSimpleProperty(inputObject, fld);
        } else {
            throw new IllegalAccessException();
        }
        return fieldValue;
