...
<t:general_template title="Add Employee">
        ...
        <form action="add-employee" method="post">
            <table>
                <tbody><tr><td>First Name: </td><td><input type="text" size="40" name="new-fname"></td></tr>
                        ...
                        <td>
                            <select name="new-employee-category-id">
                                <c:forEach var="employeeCategory" items="${requestScope.employeeCategories}">
                                    <option value="${employeeCategory.employeeCategoryId}">${employeeCategory.name}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"><button type="submit" name="status" value="create">create</button></td>
                    </tr>
                </tbody></table>
        </form>
    </jsp:attribute>
