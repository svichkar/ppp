	...
	<div align="center">
		...
		<form action="edit_student" method="post">
			...
			<select name="group">
				<c:forEach items="${groups}" var="group">
				<c:choose>
				<c:when test="${studentToEdit.studentGroup.studentGroupId == group.studentGroupId}">
			...
			<select name="status">
				<c:forEach items="${statuses}" var="status">
				<c:choose>
				<c:when test="${studentToEdit.status.statusId == status.statusId}">
			...
			<select name="term">
				<c:forEach items="${terms}" var="term">
				<c:choose>
				<c:when test="${studentToEdit.term.termId == term.termId}">
