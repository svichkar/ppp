...
public class LoanBean {
	...
	private String expirationState; //null if not expired or count of overdue days
	...
	public static List<LoanBean> getBookBeansByClientId(Long id) {
	...
	public static List<LoanBean> getAllBookBeans() {
		...
		List<LoanBean> allBookBeans = new ArrayList<>();
	...
	public static LoanBean getBookBean(Book book){
		H2DaoFactory factory = DaoFactory.getDAOFactory(DaoFactory.H2);
		List<Author> authors = new ArrayList<Author>();
		List<AuthorBook> authBook;
		LoanBean bookBean = new LoanBean();
