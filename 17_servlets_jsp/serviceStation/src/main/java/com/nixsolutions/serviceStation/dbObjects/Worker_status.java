...
public class Worker_status {
	...
	public Worker_status(Integer worker_status_id, String worker_status_name) {
	...
	public String toString() {
		return "Worker_status [worker_status_id=" + worker_status_id + ", worker_status_name=" + worker_status_name
				+ "]";
	}
