...
public class UpdateUserPageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (request.getParameter("update") != null) {
			...
			updatedUser.setLogin(request.getParameter("updatedLogin"));
			updatedUser.setPassword(request.getParameter("updatedPassword"));
			updatedUser.setEmail(request.getParameter("updatedEmail"));
			updatedUser.setRole(roleDao.findRoleById(Long.valueOf(request.getParameter("updatedRole"))));
