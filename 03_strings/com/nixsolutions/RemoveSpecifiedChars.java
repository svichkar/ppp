...
public class RemoveSpecifiedChars {
  /** 
  * Removes specified characters specified number of times
  * from string based on user input.
  */
  public static void main(String[] args) {
    ...
    System.out.println("Enter a single character to remove from the string: ");
