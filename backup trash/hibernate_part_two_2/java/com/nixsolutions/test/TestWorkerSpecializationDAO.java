...
public class TestWorkerSpecializationDAO extends DBTestCase {
	...
	public void testWorkerSpecDAOAddsEntity() throws DataSetException, Exception {
		...
		WorkerSpecialization ws = new WorkerSpecialization(0, "test");
		WorkerSpecialization tWorkerSpec = workerSpecDAO.createFrom(ws);
		...
		Assert.assertEquals(tWorkerSpec.getSpecializationId(), dbTable.getValue(dbTable.getRowCount() - 1, "specialization_id"));
		Assert.assertEquals(tWorkerSpec.getSpecializationName(), dbTable.getValue(dbTable.getRowCount() - 1, "specialization_name"));
	}
	...
	public void testWorkerSpecDAOUpdatesEntity() throws Exception {
		...
		tWorkerSpec.setSpecializationName("No Spec Name");
