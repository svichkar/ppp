...
public class EmployeeCategoryDaoH2Test extends AbstractDaoH2Test {
    ...
    protected IDataSet getDataSet() throws Exception {
        return new FlatXmlDataSet(
                getClass().getClassLoader().getResourceAsStream(dbunitConfig
                        .getString("dbunit.employee.category.initial")));
    }
    ...
    public void testCreate() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(getClass().getClassLoader()
                .getResourceAsStream(dbunitConfig
                        .getString("dbunit.employee.category.expected.create")));
    ...
    public void testUpdate() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(getClass().getClassLoader()
                .getResourceAsStream(dbunitConfig
                        .getString("dbunit.employee.category.expected.update")));
        ITable expectedTable = expectedDataSet.getTable("employee_category");
        Assertion.assertEquals(expectedTable, DefaultColumnFilter
                .includedColumnsTable(actualTable, expectedTable.getTableMetaData().getColumns()));
    ...
    public void testDelete() throws Exception {
        ...
        IDataSet expectedDataSet = new FlatXmlDataSet(getClass().getClassLoader()
                .getResourceAsStream(dbunitConfig
                        .getString("dbunit.employee.category.expected.delete")));
        ITable expectedTable = expectedDataSet.getTable("employee_category");
    ...
    public void testGetEmployeeCategoryList() {
        List<EmployeeCategory> employeeCategoryList 
                = employeeCategoryDaoInstance.getEmployeeCategoryList();
        assertEquals(3, employeeCategoryList.size());
    }

    public void testGetEmployeeCategoryListLimit() {
        List<EmployeeCategory> employeeCategoryListLimit 
                = employeeCategoryDaoInstance.getEmployeeCategoryList(2);
    ...
    public void testGetEmployeeCategoryListOffset() {
        List<EmployeeCategory> employeeCategoryListOffset 
                = employeeCategoryDaoInstance.getEmployeeCategoryList(1, 2);
        assertEquals(2, employeeCategoryListOffset.size());
        assertEquals(new Short((short) 2), employeeCategoryListOffset.get(0)
                .getEmployeeCategoryId());
        assertEquals(new Short((short) 3), employeeCategoryListOffset.get(1)
                .getEmployeeCategoryId());
    }
