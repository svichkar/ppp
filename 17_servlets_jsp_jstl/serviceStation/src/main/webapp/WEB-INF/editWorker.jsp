...
<t:mainTemplate title="Worker Page">
	<jsp:attribute name="content_area">
		...
		<form id="worker" action="updateField" method="post">
				<input hidden="hidden" name="worker_id" value="${worker.worker_id}" />
				<input hidden="hidden" name="user_id" value="${worker.user_id}" />
...
<table>
				...
				<tr>
					...
					<c:choose>
					<c:when test="${spec.specialization_id == worker.specialization_id}">
				...
				<tr>
					...
					<td class="nav-menu"><input name="user_login" value="${user.user_login}" /></td>
				</tr>
				<tr>
					<td class="nav-menu"><b>User password</b></td>
					<td class="nav-menu"><input name="user_password" value="${user.user_password}" /></td>
				</tr>
				<tr>
				<td class="nav-menu" colspan="2">
