...
<t:template title="Journal">
	...
	<div class="forms">
       <h2>Journal</h2>
       <h3>Add Record</h3>
       <form action="journals" method="post" onsubmit="return validate(this, optionsForAddJournal)">
       ...
       <span class="hint">Select student from the list</span>
       </td>
       </tr>
       <tr>
       <td>Subject : </td>
       ...
       <span class="hint">Select subject from the list</span>
       </td>
       </tr>
       <tr>
       <td>Grade : </td>
       ...
       <span class="hint">Select grade from the list</span>
       </td>
       </tr>
       </table>
