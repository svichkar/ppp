...
<table>
			...
			<tr>
				<td class="nav-menu"><p>Already added parts</p>
						...
						<table class="nav-menu">
							<c:forEach var="oPart" items="${parts}">
								<tr>
					<form id="partInOrder" action="editPartInOrder" method="post">
								...
								<td class="nav-menu"><p>
									...
									<input type="submit" name="action"
										formaction="deletePartInOrder" value="delete" />
									</td>
					</form>
								</tr>
							</c:forEach>
						</table>
					<form id="partInOrder" action="addPartToOrder" method="post">
						<input hidden="hidden" name="action" value="add" /><select
							...
							name="target" value="updateField">Add</button>
					</form></td>
				<td class="nav-menu"><form id="order"
						action="updateOrderGeneralInfo" method="post">
						<table class="data">
							<tr>
								<th># Order</th>
				...
				<td class="nav-menu"><p>Already added workers</p>
					...
					<form id="orderWorker" action="addWorkerOrder" method="post">
