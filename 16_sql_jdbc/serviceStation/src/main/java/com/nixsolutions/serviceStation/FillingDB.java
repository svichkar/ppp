...
fillingDB();
	...
	public static void fillingDB() throws SQLException {
		...
		try {
			...
			stmt.addBatch(
					"INSERT INTO sqllab.customer (first_name, last_name, phone) " + "VALUES('Petr','Petrov','23-3455-5435');");
			stmt.addBatch("INSERT INTO sqllab.customer (first_name, last_name, phone)"
			...
			stmt.addBatch("INSERT INTO sqllab.worker_specialization (specialization_name) " + "VALUES('mechanik low');");
			stmt.addBatch("INSERT INTO sqllab.worker_specialization (specialization_name) " + "VALUES('mechanik high');");
			stmt.addBatch("INSERT INTO sqllab.worker_specialization (specialization_name) " + "VALUES('electric');");
			stmt.addBatch("INSERT INTO sqllab.worker_specialization (specialization_name) " + "VALUES('diagnostician');");
			...
			/* sqllab.part */
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('tyaga ВАЗ', '81-56fa354fa', '6');");
			stmt.addBatch("INSERT INTO sqllab.part (part_name, vendor, amount) "
					+ "VALUES('brake pads OPEL', '5634-fafa815', '12');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount)" + "VALUES('brake pads BMW', '54-fafa81563', '12');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('tyaga BMW', '8156fa354-fa', '6');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('shrovaya BMW', '8156354-fafa', '5');");
			stmt.addBatch("INSERT INTO sqllab.part (part_name, vendor, amount) "
					+ "VALUES('brake pads AUDI', '54-fafa81563', '12');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('tyaga AUDI', '8156fa354-fa', '6');");
			stmt.addBatch("INSERT INTO sqllab.part (part_name, vendor, amount) "
					+ "VALUES('lamp H4 PHILIPS', '6354-f815afa', '10');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('lamp H4 OSRAM', '81a56354-faf', '10');");
			stmt.addBatch(
					"INSERT INTO sqllab.part (part_name, vendor, amount) " + "VALUES('shrovaya AUDI', '8156354-fafa', '5');");
			/* sqllab.order_status */
