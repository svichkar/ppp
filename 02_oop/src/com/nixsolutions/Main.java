...
public class Main {
    ...
    /**
     * Creates array of 10 random vehicles. Simulates move of vehicles. Sorts
     * array of vehicles by passed distance.
     */
	...
	for (int i = 0; i < transportArray.length; i++) {
	    ...
	    case 0:
		transportArray[i] = new Car();
		break;
	    case 1:
		transportArray[i] = new Bus();
		break;
	    case 2:
		transportArray[i] = new Bicycle();
		break;
	    default:
		break;
	    }
