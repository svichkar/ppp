...
/**
 * Created by pantiukhin on 1/26/2016. Subject: working with the Java DateTime API
 */
public class DateAndTime {
    ...
    //Displays what dates for the specified year and month fall on Mondays
    ...
    public void findFridayThirteenth() {
        int year = 0;
        int month = 0;
        int dayOfWeek = 0;
        String monthName = "";
        ...
        if (dayOfWeek == 6) {
            System.out.println("Bingo! The 13th of " + monthName + ", " + year + " is Friday");
        } else {
    ...
    public String displayTimeElapsed() {
        ...
        try {
            System.out.println("Enter the desired year (the year must be equal to or greater than the current year) and press Enter: ");
            BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
            year = Integer.parseInt(reader.readLine());
            System.out.println("Enter the desired month number (0 for January) and press Enter: ");
            month = Integer.parseInt(reader.readLine());
            System.out.println("Enter the desired day (from 1 to 31; if it is the current year and the current month, the date must be less than the current date) and press Enter: ");
        ...
        pastCalendar.set(Calendar.DAY_OF_MONTH, 1);
        pastCalendar.set(Calendar.DATE, day);
