...
public class AdminPageServlet extends HttpServlet {
    ...
    protected String produceUserListHtml() {
        DaoFactory daoFactory = new DaoFactory();
        RoleDao roleDao = daoFactory.getRoleDao();
        ...
        for (User u : users) {
            ...
            updateUser.append("<td><input type=\"password\" name=\"pass\" value=\"" + u.getUserPassword() + "\" maxlength=\"20\" pattern=\"[^А-Яа-яёЁ]{3,20}\" required/></td>\n");
        ...
        StringBuilder newUser = new StringBuilder("<form action=\"admin\" method=\"post\">\n" +
                ...
                "<td><input type=\"password\" name=\"pass\" pattern=\"[^А-Яа-яёЁ]{3,20}\" required placeholder=\"password\"></input></td>\n" +
