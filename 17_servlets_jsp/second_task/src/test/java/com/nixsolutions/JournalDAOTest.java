...
public class JournalDAOTest {
	...
	public void setUp() throws DatabaseUnitException {
		...
		List <Journal> st = journal.findAllJournals();
		journalId = Long.valueOf(st.get(st.size()-1).getJournalId() + 1);
	}
	...
	public void shouldCreateJournal() throws DataSetException {
		Journal journalNew = new Journal(journalId, (long) 7, (long) 6, 4);
	...
	public void shouldUpdateJournal() throws DataSetException {
		journal.createJournal(new Journal(journalId, (long) 7, (long) 6, 4));
		Journal journalUpdate = new Journal(journalId, (long) 7, (long) 6, 5);
	...
	public void shouldDeleteJournal() throws DataSetException {
		Journal journalDelete = new Journal(journalId, (long) 7, (long) 6, 4);
