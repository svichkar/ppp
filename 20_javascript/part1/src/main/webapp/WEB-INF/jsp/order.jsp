...
<t:general_template>
	...
	<jsp:attribute name="content_area">
				...
				<select name="car_id">
					<c:forEach var="car" items="${cars}">
						<option value="${car.carId}"
									<c:if test="${car.carId eq oiw.car.carId}">selected</c:if>>
		...
		<tr>
			<td>Start time:</td>
			<td>
				<input type="text" name="datetime_start" value="${orderInWork.datetime_start}" />
			</td>
		</tr>
		<tr>
			<td>Stop time:</td>
			<td>
				<input type="text" name="datetime_end" 	value="${orderInWork.datetime_end}" />
			</td>
		</tr>
		<tr>
