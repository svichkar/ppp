...
<t:templateManager title="Journal" activePage="Journals">
			...
			<form action="journals" method="post">
				<table class="form-table">
					<tr>
						<td>Student : </td>
						<td>
							<select name="newStudent" size="1" required>
					...
					<tr>
						<td>Subject : </td>
						<td>
							<select name="newSubjectName" size="1" required>
					...
					<tr>
						<td>Grade : </td>
						<td>
							<select name="newGradeName" size="1" required>
		...
		<table class="centered-table" border="1">
			...
			<tbody>
				<c:forEach var="journal" items="${journals}">
					<tr>
						<td>
							<c:out value="${journal.journalId}" />
						</td>
						<td>
							<c:out value="${journal.studentNameInGroup}" />
						</td>
						<td>
						...
						<td>
							<div class="action">
								<form action="updateJournal" method="get">
