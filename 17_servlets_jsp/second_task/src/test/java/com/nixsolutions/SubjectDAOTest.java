...
public class SubjectDAOTest {
	...
	public void setUp() throws DatabaseUnitException {
		...
		List <Subject> st = subject.findAllSubjects();
		subjectId = Long.valueOf(st.get(st.size()-1).getSubjectId()+1);
	}
	...
	public void shouldCreateSubject() throws DataSetException {
		Subject subjectNew = new Subject(subjectId, "Psychology", (long) 3);
	...
	public void shouldUpdateSubject() throws DataSetException {
		subject.createSubject(new Subject(subjectId, "Psychology", (long) 3));
		Subject subjectUpdate = new Subject(subjectId, "Psychology and Ethics", (long) 3);
	...
	public void shouldDeleteSubject() throws DataSetException {
		Subject subjectDelete = new Subject(subjectId, "Psychology", (long) 3);
