...
public class Float {
    /**
     * Asks the user to enter floating point number, converts the input to
     * another type of notation, then prints the result on the screen.
     */
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (s.toLowerCase().contains(e)) {
                ...
                System.out.println(
                        "This number in normal format: " + bd.toPlainString());
            } else {
                System.out.println("Received a number in normal format");
                DecimalFormat fmt = new DecimalFormat("0.00E00");
                System.out.println("This number in exponential format: "
                        + fmt.format(bd.doubleValue()));
            }
        }
    }
