...
<t:templateManager title="Students" activePage="Students">
			...
			<form action="students" method="post">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input type="text" name="newAdmissionDate" required>
						</td>
					</tr>
					<tr>
						<td>Group Name : </td>
						<td>
							<select name="newGroupName" size="1" required>
					...
					<tr>
						<td>Status Name : </td>
						<td>
							<select name="newStatusName" size="1" required>
			...
			<form action="students" method="post">
				<table class="form-table">
					...
					<tr>
						<td>Group Name : </td>
						<td>
							<select name="searchGroupId" size="1">
								<option selected disabled>--Select group--</option>
								<c:forEach var="group" items="${groups}">
									<option value="<c:out value="${group.groupId}" />">
										<c:out value="${group.groupName}" />
