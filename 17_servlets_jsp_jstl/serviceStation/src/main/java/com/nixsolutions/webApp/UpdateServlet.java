...
public class UpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "updateCar": {
			...
			DaoFactory.getCarDaoImpl().updateCarByID(carModel, car_description, vinNumber, regNumber,
					Integer.decode(customer_id), Integer.decode(car_id));
	...
	public void editExistingCar(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String car_id = request.getParameter("car_id");
		request.setAttribute("car", getCarFullInfo(DaoFactory.getCarDaoImpl().getCarByID(Integer.decode(car_id))));
		request.setAttribute("customers", getCustomerFullInfo(DaoFactory.getCustomerDaoImpl().getAllCustomers()));
	...
	private CarFullInfo getCarFullInfo(Car car) {
