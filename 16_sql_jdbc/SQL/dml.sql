...
INSERT INTO worker_specification (spec_name) VALUES ('electrician');
INSERT INTO worker_specification (spec_name) VALUES ('engine mechanic');
INSERT INTO worker_specification (spec_name) VALUES ('welder');
INSERT INTO worker_specification (spec_name) VALUES ('car suspension mechanic');
INSERT INTO worker_specification (spec_name) VALUES ('programmist');
--fill table order_status
INSERT INTO order_status (order_status_name) VALUES ('pending');
INSERT INTO order_status (order_status_name) VALUES ('work_in_progress');
INSERT INTO order_status (order_status_name) VALUES ('completed');
INSERT INTO order_status (order_status_name) VALUES ('cancelled');
INSERT INTO order_status (order_status_name) VALUES ('refused');
--fill table part
...
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start) VALUES (1, 'Need to change tires', 1, parsedatetime('2015-11-07 11:00:00', 'yyyy-MM-dd hh:mm:ss'));
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start) VALUES (2, 'knoking valves', 2, parsedatetime('2015-11-06 11:00:00', 'yyyy-MM-dd hh:mm:ss'));
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start) VALUES (2, 'replacement chain', 3, parsedatetime('2015-11-05 11:30:00', 'yyyy-MM-dd hh:mm:ss'));
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start) VALUES (2, 'replacement pipe', 4, parsedatetime('2015-11-05 11:30:00', 'yyyy-MM-dd hh:mm:ss'));
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start, datetime_end) VALUES (5, 'brocken engine', 5, parsedatetime('2015-11-05 11:30:00', 'yyyy-MM-dd hh:mm:ss'), parsedatetime('2015-11-08 11:30:00', 'yyyy-MM-dd hh:mm:ss'));
INSERT INTO order_in_work (order_status_id, description, car_id, datetime_start, datetime_end) VALUES (3, 'service at 50k km', 4, parsedatetime('2015-11-07 09:30:00', 'yyyy-MM-dd hh:mm:ss'), parsedatetime('2015-11-07 14:30:00', 'yyyy-MM-dd hh:mm:ss'));
--fill table order_worker
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (4, 1, false);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (2, 2, false);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (2, 3, false);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (3, 4, false);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (2, 5, true);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (3, 6, true);
INSERT INTO order_worker (worker_id, order_id, completed) VALUES (4, 6, true);
--fill table part_order
INSERT INTO part_order (order_id, part_id, amount) VALUES (1,7,16);
INSERT INTO part_order (order_id, part_id, amount) VALUES (2,5,16);
INSERT INTO part_order (order_id, part_id, amount) VALUES (3,9,1);
INSERT INTO part_order (order_id, part_id, amount) VALUES (4,4,1);
INSERT INTO part_order (order_id, part_id, amount) VALUES (5,8,1);
