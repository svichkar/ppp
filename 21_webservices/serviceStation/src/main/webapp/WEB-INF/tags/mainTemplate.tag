...
<html>
	...
	<body>
		<table class="nav-menu">
			<tr>
				<td class="nav-menu" colspan="5">
					<form action="<m:url value="/logout"></m:url>"	method="GET">
			...
			<tr>
				...
				<td class="nav-menu">
					<form action="<m:url value="/admin/carPage"></m:url>" method="GET">
						<button type="submit" class="btn btn-primary btn-block btn-large">Cars</button>
					</form>
				</td>
				<td class="nav-menu">
					<form action="<m:url value="/admin/customerPage"></m:url>" method="GET">
						<button type="submit" class="btn btn-primary btn-block btn-large">Customers</button>
					</form>
				</td>
				<td class="nav-menu">
					<form action="<m:url value="/admin/workerPage"></m:url>" method="GET">
						<button type="submit" class="btn btn-primary btn-block btn-large">Workers</button>
					</form>
				</td>
				<td class="nav-menu">
					<form action="<m:url value="/admin/partPage"></m:url>" method="GET">
