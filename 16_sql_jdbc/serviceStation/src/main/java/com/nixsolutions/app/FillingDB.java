...
public class FillingDB {
	...
	public static void fillingDB() throws SQLException, ClassNotFoundException {
		...
		try {
			...
			customerDaoImpl.createNewCustomer("IVAN", "IVANOV", "1-23-3455-5435", 2);
			customerDaoImpl.createNewCustomer("Petr", "Petrov", "23-3455-5435", 3);
			customerDaoImpl.createNewCustomer("Fedor", "Fedorov", "1-23-3454735863", 4);
			customerDaoImpl.createNewCustomer("Alex", "Alkov", "827382755-5435", 5);

			/* sqllab.car */
			CarDaoImpl carDaoImpl = DaoFactory.getCarDao();
