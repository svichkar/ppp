...
public class UpdateSubjectPageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (request.getParameter("update") != null) {
			...
			updatedSubject.setSubjectName(request.getParameter("updatedSubjectName"));
			updatedSubject.setTerm(termDao.findTermById(Long.valueOf(request.getParameter("updatedTermName"))));
