...
public class EditStudentServlet extends HttpServlet {
	...
	student.setStatusId(DaoFactory.getStatus().getByStatusName(request.getParameter("status")).getStatusId());
	student.setTermId(DaoFactory.getTerm().getTermByAlias(request.getParameter("term")).getTermId());
	student.setStudentGroupId(
