...
<t:template title="Subjects">
	...
	<div class="forms">
       <h2>Subjects</h2>
       <h3>Add Subject</h3>
       <form action="subjects" method="post" onsubmit="return validate(this, optionsForAddSubject)">
       <table class="form-table">
       <tr>
					<td>Subject Name : </td>
       <td><input type="text" name="newSubjectName" required>
       				<span class="hint">Enter subject name in text format</span></td>
				</tr>
       <tr>
					<td>Term Name : </td>
       ...
       <form action="subjects" method="post" onsubmit="return validate(this, optionsForSearchSubject)">
       <table class="form-table">
       <tr>
					<td>Subject Name : </td>
					<td><input type="text" name="searchSubjectName">
					<span class="hint">Enter subject name for search</span></td>
				</tr>
       <tr>
					<td>Term Name : </td>
					<td><select name="searchTermId" size="1">
       <option selected disabled>--Select term--</option>
       <c:forEach var="term" items="${terms}">
       <option value="<c:out value="${term.termId}"/>"><c:out
											value="${term.termName}" /></option>
        ...
        <table class="centered-table" border="1">
            ...
            <c:forEach var="subject" items="${subjects}">
                <tr>
                    ...
                    <td><c:out value="${subject.term.termName}" /></td>                    
                    <td><div class="action">
