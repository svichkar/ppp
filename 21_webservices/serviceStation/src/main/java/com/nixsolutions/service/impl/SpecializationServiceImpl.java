...
public class SpecializationServiceImpl implements SpecializationService {
	...
	public WorkerSpecialization getSpecialization(Integer specializationId) {
		return specDao.getSpecialization(specializationId);
	}
	 ...
	 */
	@Override
	public WorkerSpecialization getSpecialization(String specializationId) {
		return getSpecialization(Integer.decode(specializationId));
	}
