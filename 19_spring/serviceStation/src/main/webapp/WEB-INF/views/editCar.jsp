...
<t:mainTemplate title="Cars Page">
	<jsp:attribute name="content_area">
		...
		<form id="partInOrder" action="updateCar" method="post">
...
<table>
				...
				<tr>
					...
					<td class="nav-menu"><input name="carModel" value="${car.car_model}" /></td>
				</tr>
				<tr>
					<td class="nav-menu"><b>Car registration number</b></td>
					<td class="nav-menu"><input name="regNumber" value="${car.reg_number}" /></td>
				</tr>
				<tr>
					<td class="nav-menu"><b>Car VIN number</b></td>
					<td class="nav-menu"><input name="vinNumber" value="${car.vin_number}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="nav-menu"><input disabled="disabled" name="carOwner" value="${car.customer.last_name} ${car.customer.first_name}" />
					<br/>
					<b>Actual owner</b>
					<br/>
