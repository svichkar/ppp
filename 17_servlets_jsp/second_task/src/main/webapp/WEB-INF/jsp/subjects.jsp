...
<t:template title="Subjects">
	...
	<div class="forms">
       ...
       <tr>
					<td>Subject Name : </td>
					<td><input type="text" name="searchSubjectName"></td>
				</tr>
       <tr>
					<td>Term Name : </td>
       ...
       <h3>List of subjects</h3>       
        <table class="centered-table" border="1">
            ...
            <c:forEach var="subject" items="${subjects}">
                <tr>
                    <td><c:out value="${subject.subject.subjectId}" /></td>
                    <td><c:out
								value="${subject.subject.subjectName}" /></td>
                    <td><c:out value="${subject.term.termName}" /></td>                    
                    <td><div  class="action"><form action="updateSubject" method="get">
                    <input type="hidden" name="subject_id"
									value="<c:out value="${subject.subject.subjectId}"/>">
