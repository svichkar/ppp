...
public class DAOApp {
	...
	public static void main(String[] args) {
		...
		RoleDAOImpl role = DAOFactory.getRole();
		role.createRole(1, "admin");
		role.createRole(2, "basic");
		LOG.info("=====Table role is filled=====");
		UserDAOImpl user = DAOFactory.getUser();
		user.createUser(1, "admin", "admin", "admin@mail.com", 1);
		user.createUser(2, "test", "test", "manager@mail.com", 2);
