...
import com.nixsolutions.dao.impl.CarCustomerDAOImpl;
...
import com.nixsolutions.dao.impl.WorkerStatusSpecificationImpl;
...
public class Navigation extends HttpServlet {
	...
	private CarCustomerDAOImpl carcustomerImpl;
	private WorkerStatusSpecificationImpl workerstatusspecificationImpl;
	private OrderInWorkCarStatusDAOImpl orderInWorkCSImpl;
	...
	public Navigation() throws Exception {
		...
		carcustomerImpl = (CarCustomerDAOImpl) factory.getDao(CarCustomer.class);
		workerstatusspecificationImpl = (WorkerStatusSpecificationImpl) factory.getDao(WorkerStatusSpecification.class);
		orderInWorkCSImpl = (OrderInWorkCarStatusDAOImpl) factory.getDao(OrderInWorkCarStatus.class);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Role role = roleImpl.findByPK(user.getRole_id());
